...
static rosidl_typesupport_introspection_c__MessageMember ur3_moveit_control__action__UR3Control_Goal__rosidl_typesupport_introspection_c__UR3Control_Goal_message_member_array[3] = {
  {
    "command_type",  // name
