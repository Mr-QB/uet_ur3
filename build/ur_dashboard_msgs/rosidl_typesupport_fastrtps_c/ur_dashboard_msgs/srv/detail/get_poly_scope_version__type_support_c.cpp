  ...
  void * untyped_ros_message)
{
  ...
  _GetPolyScopeVersion_Request__ros_msg_type * ros_message = static_cast<_GetPolyScopeVersion_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  // Field name: version
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ur_dashboard_msgs, msg, VersionInformation
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GetPolyScopeVersion_Response__ros_msg_type * ros_message = static_cast<_GetPolyScopeVersion_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: answer
  {
    std::string tmp;
    cdr >> tmp;
